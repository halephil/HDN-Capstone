 ...
 */
public class DrugListFragment extends Fragment implements View.OnClickListener  {
     ...
     * @return A new instance of fragment DrugListFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DrugListFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.addDrugBtn).setOnClickListener(this);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
           ...
           Toast.makeText(context, "Home Frag Attached", Toast.LENGTH_SHORT).show();
        }
    }
